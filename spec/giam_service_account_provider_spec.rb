...
describe Puppet::Type.type(:giam_service_account).provider(:google) do
  before(:all) do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'Giam_service_account[title0]' do
              subject do
                catalog.resource('Giam_service_account[title0]').provider
              end

              it { is_expected.to have_attributes(name: 'title0') }
              it do
                is_expected
                  .to have_attributes(project_id: 'test project_id#0 data')
              end
              it do
                is_expected
                  .to have_attributes(unique_id: 'test unique_id#0 data')
              end
            ...
            context 'Giam_service_account[title1]' do
              subject do
                catalog.resource('Giam_service_account[title1]').provider
              end

              it { is_expected.to have_attributes(name: 'title1') }
              it do
                is_expected
                  .to have_attributes(project_id: 'test project_id#1 data')
              end
              it do
                is_expected
                  .to have_attributes(unique_id: 'test unique_id#1 data')
              end
            ...
            context 'Giam_service_account[title2]' do
              subject do
                catalog.resource('Giam_service_account[title2]').provider
              end

              it { is_expected.to have_attributes(name: 'title2') }
              it do
                is_expected
                  .to have_attributes(project_id: 'test project_id#2 data')
              end
              it do
                is_expected
                  .to have_attributes(unique_id: 'test unique_id#2 data')
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Giam_service_account[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Giam_service_account[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:giam_service_account).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
