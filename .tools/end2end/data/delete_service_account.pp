...
#       puppet apply .tools/end2end/data/delete_service_account.pp
#
...
giam_service_account { 'puppet-e2e-test-account@graphite-playground.google.com.iam.gserviceaccount.com':
  ensure       => absent,
