...
#       puppet apply .tools/end2end/data/delete_service_account_key.pp
#
...
giam_service_account { 'myaccount':
  ...
  name         =>
    'puppet-e2e-test-account@graphite-playground.google.com.iam.gserviceaccount.com',
...
#
# $ FACTER_key_id puppet apply .tools/end2end/data/delete_service_account_key.pp
if !defined('$key_id') {
